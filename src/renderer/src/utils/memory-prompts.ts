...
export const updateMemoryPrompt: string = `You are a smart memory manager which controls the memory of a system.
...
export function getUpdateMemoryMessages(
  ...
  const systemPrompt = customPrompt || updateMemoryPrompt
  return systemPrompt
